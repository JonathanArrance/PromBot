...
def show_chat_gpt_search(event: ExecutionBaseEvent, params: ChatGPTParams):
    ...
    try:
        if params.search_term in lru_cache:
            ...
            #NOTE: The prompt was changed from the original so that a kubectl command would also be returned.
